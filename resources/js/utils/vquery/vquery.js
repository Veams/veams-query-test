...
/**
 * vQuery selector function
 *
 * @param {String | Object} selector - selector (string, vQuery object, element)
 * @param {Object} [context] - context (vQuery object, element)
 */
let vQuery = function (selector, context) {
	return new vQueryObject(selector, context);
};


// vQuery version
vQuery.version = 'v1.0.0';
 ...
 */
vQuery.parseHTML = function (htmlString) {
...
/**
 * vQuery DOM wrapper object
 *
 * @param {String | Object} selector - selector (string, vQuery object, element)
 * @param {Object} [context] - context (vQuery object, element)
 */
let vQueryObject = function (selector, context) {
	let scope;
	let i = 0;
	this.nodes = [];
 ...
 * vQuery object, or element
 *
 * @param {String|Object} selector - selector (string, vQuery object, element)
 * @return {Object} - vQuery object
 */
vQueryObject.prototype.find = function (selector) {

	return new vQueryObject(selector, this);
};
 ...
 */
vQueryObject.prototype.hasClass = function (className) {
	if (classListSupport) {
...
/**
 * Check the current matched set of elements against a selector, element, or vQuery object and return true if
 ...
 */
vQueryObject.prototype.is = function (selector) {
	let i = 0;
 ...
 * @return {Object} - vQuery object
 */
vQueryObject.prototype.addClass = function (classNames) {
	let i = 0;
 ...
 * @return {Object} - vQuery object
 */
vQueryObject.prototype.removeClass = function (classNames) {
	let i = 0;
	let classes = classNames && classNames.split(' ');
 ...
 * @return {String|Object} - html contents | vQuery object
 */
vQueryObject.prototype.html = function (htmlStr) {
	let i = 0;
 ...
 *
 * @param {String|Object} element - html string | vQuery object | element
 * @return {Object} - vQuery object
 */
vQueryObject.prototype.append = function (element) {
	let i = 0;
 ...
 * @return {Object} - vQuery object
 */
vQueryObject.prototype.prepend = function (element) {
	let i = 0;
 ...
 * @return {Object} - vQuery object
 */
vQueryObject.prototype.before = function (element) {
	let i = 0;
 ...
 * @return {Object} - vQuery object
 */
vQueryObject.prototype.after = function (element) {
	let i = 0;
 ...
 * @return {Object} - vQuery object
 */
vQueryObject.prototype.remove = function () {
	let i = 0;
 ...
 * @return {Object} - vQuery object
 */
vQueryObject.prototype.empty = function () {
	let i = 0;
 ...
 * @return {Object} - vQuery object containing node at given index of original node list
 */
vQueryObject.prototype.eq = function (index) {
	return new vQueryObject(this.nodes[index]);
};
 ...
 * @return {String|Number|Boolean|Object} - attribute value | vQuery object
 */
vQueryObject.prototype.attr = function (attrName, attrVal) {
	let i = 0;
 ...
 * @return {Object} - vQuery object
 */
vQueryObject.prototype.removeAttr = function (attrName) {
	let i = 0;
 ...
 * @return {String|Object} - text | vQuery object
 */
vQueryObject.prototype.text = function (text) {
	let i = 0;
	let combinedText = '';
 ...
 * @return {String|Object} - css value | vQuery object
 */
vQueryObject.prototype.css = function (cssProp, cssVal) {
	let i = 0;
 ...
 */
vQueryObject.prototype.clone = function (withChildren) {
 ...
 */
vQueryObject.prototype.index = function () {
 ...
 * @return {Object} - vQuery object
 */
vQueryObject.prototype.on = function (eventNames, handler) {
	let i = 0;
	let j = 0;
 ...
 * @return {Object} - vQuery object
 */
vQueryObject.prototype.off = function (eventNames, handler) {
	let i = 0;
	let j = 0;
	let events = eventNames.split(' ');
 ...
 * @return {Object} - vQuery object
 */
vQueryObject.prototype.trigger = function (eventNames, customData) {
	let i = 0;
	let j = 0;
	let events = eventNames.split(' ');
